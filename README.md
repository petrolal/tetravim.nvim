...
`bootstrap.sh` is idempotent — safe to re-run after `git pull` to refresh
plugins and tools. See [INSTALL.md](INSTALL.md) for exactly what it checks,
what it installs, and troubleshooting/uninstall steps.
